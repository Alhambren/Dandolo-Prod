  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900">
      ...
      <div className="bg-gray-800 border-b border-gray-700 px-3 py-2 relative">
        <div className="flex items-center justify-between max-w-xs mx-auto lg:max-w-4xl px-2">
          <button
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-xs mx-auto lg:max-w-4xl p-2 lg:p-4">
          {messages.length === 0 ? (
      ...
      <div className="border-t border-gray-700 bg-gray-800 p-3 pb-safe">
        <div className="max-w-xs mx-auto lg:max-w-4xl px-2">
          {!activeProvider && (
